...
A GUS demo dashboard (preview below) and falconexe's Ultimate UNRAID Dashboard v1.5 (UUD) are included out of the box.
...
## Key features
1. Grafana server. Include both a GUS demo dashboard and falconexe's Ultimate UNRAID Dashboard v1.5.
1. Influxdb
